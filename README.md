...
# 🚀프로젝트 업데이트 안내
> 기존의 Kotlin(XML, SQLite) 구조에서 최신 Android 기술을 적용하여 보다 최적화된 구조로 재구성되었습니다.   

#### 새로운 기능 및 개선사항
- Jetpack Compose 도입 : 코드 간소화 및 UI 개선   
- MVVM 패턴 적용 : 코드 구조 개선 및 유지보수성 향상   
- Room + Firestore 데이터 연동 : 오프라인 <-> 온라인 데이터 동기화   
- Firebase 인증 기반 사용자 권한 관리 (관리자, 회원, 비회원)   

[업데이트된 프로젝트 보러가기](https://github.com/lyuhw1023/smartportfolio_plus)
